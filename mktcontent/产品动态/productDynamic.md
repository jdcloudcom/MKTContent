[
	...
	{
		"introduce":"Minecraft: Education Edition  Formal Release",
		"name":"Minecraft: Education Edition  Formal Release",
		"description":"Build a future education world, provide a K12 immersion teaching platform and culture the future comprehensive capacity of students.",
		"id":2504
	},
	{
		"introduce":"Detect video, finds problematic pictures and guarantee video picture quality.",
		"name":"Additional video quality detection function",
		"description":"Quality Detection is based on self-developed video picture review technology of JD Cloud, which can detect various independent indicators of video picture quality, precisely identify static frames, color shifts, black burst and other problems in video files, discovering picture quality in advance, reducing manual check cost and improving quality and efficiency of the entire business and video production.",
		"id":2510
	},
	{
		"introduce":"Provide full-link HTTPS security acceleration scheme, support certificate uploading and redirection type management to guarantee security of business contents.",
		"name":"Provide HTTPS Security Acceleration",
		"description":"Provide full-link HTTPS security acceleration scheme, support certificate uploading and redirection type management to guarantee security of business contents.",
		"id":2511
	},
	{
		"introduce":"Automatic Attack Traceability",
		"name":"Provide security incidents traceability",
		"description":"Automatic traceability provides original data overview, helps you quickly position attack source, finds invasion reason and repair risks",
		"id":2512
	},
	{
		"introduce":"Redis 2.8 version supports slow log in searching commands where the record execution time exceeds the set duration",
		"name":"Redis 2.8 Slow Log",
		"description":"Redis 2.8 version supports slow log in searching commands where the record execution time exceeds the set duration",
		"id":2513
	},
	{
		"introduce":"Provide FIFO Queue Service",
		"name":"Provide FIFO Queue Service",
		"description":"1. FIFO Queue Orderly Grouping\n2. Message Deduplication Function",
		"id":2514
	},
	{
		"introduce":"Read-only instances can be accessed through online DMS service",
		"name":"Read-only instances support DMS function",
		"description":"Read-only instances can be accessed through online DMS service",
		"id":2515
	},
	{
		"introduce":"Read-only instances can be accessed through online DMS service",
	...
	{
		"introduce":"For primary and backup instances, the instance configuration can be upgraded or degraded with the configuration change operation",
		"name":"Primary and backup instances support configuration change",
		"description":"For primary and backup instances, the instance configuration can be upgraded or degraded with the configuration change operation",
		"id":2518
	},
	{
		"introduce":"For primary and backup instances, the instance configuration can be upgraded or degraded with the configuration change operation",
	...
	{
		"introduce":"Alarm configuration supports tag group and association with alarm template",
		"name":"Alarm configuration supports tag group and association with alarm template",
		"description":"Alarm rules can be flexibly and conveniently configured, tag groups can be added to alarm resources and triggering conditions support association with alarm template. Scenarios where setting and updating of mass resource alarm rules are satisfied.",
		"id":2521
	},
	{
		"introduce":"Create JCS for MySQL  Support customized access port",
		"name":"Instances support customized port",
		"description":"Create JCS for MySQL  Support customized access port",
		"id":2522
	},
	{
		"introduce":"Create JCS for Percona  Support customized access port",
		"name":"Instances support customized port",
		"description":"Create JCS for Percona  Support customized access port",
		"id":2523
	},
	{
		"introduce":"Create JCS for MariaDB  Support customized access port",
		"name":"Instances support customized port",
		"description":"Create JCS for MariaDB  Support customized access port",
		"id":2524
	},
	{
		"introduce":"Functions such as threat overview, reports and billing are added to Endpoint Security",
		"name":"Functions such as threat overview, reports and billing are added",
		"description":"Functions such as threat overview, reports and billing are added to Endpoint Security",
		"id":2525
	},
	{
		"introduce":"Add namespace",
		"name":"Add namespace",
		"description":"The namespace implements the isolation of resources and services, such as development, test and production environment, to avoid impacting service calling and configuration pushing under different environments.",
		"id":2526
	},
	{
		"introduce":"Upgrade Application Deployment Function",
		"name":"Upgrade Application Deployment Function",
		"description":"It deeply integrates the deployment of Virtual Machines. It takes only 3 steps from creating application to completing deployment (if you have purchased cloud resources and enabled namespace); in the process of creating the application, we also help users initiate java running environment (support JDK7/JDK8 currently) to reduce user operations.",
		"id":2527
	},
	{
		"introduce":"Add Resource Pool Management",
		"name":"Add Resource Pool Management",
		"description":"In the deployment and running of JD Distributed Service application, to enhance the operation efficiency, we directly offer users a unified management entrance for related resources. When users assign and adjust cloud resources including container and Virtual Machines, they no longer need to frequently search and redirect among cloud products on the cloud platform.",
		"id":2528
	},
	{
		"introduce":"Image Matting  Open Beta",
		"name":"Image Matting  Open Beta",
		"description":"Image Matting service is an intelligent service matting background for the image body and producing transparent bottom image. Based on machine learning and intelligent image recognition technology, image processing efficiency can be greatly promoted and labor cost can be reduced.",
		"id":2529
	},
	{
		"introduce":"Photo Filters Matching  Open Beta",
		"name":"Photo Filters Matching  Open Beta",
		"description":"Photo Filters Matching Service is a practical function intelligently extending a single color matching scheme to multiple color matching results. Based on intelligent image recognition technology, image colors can be precisely recognized and replaced, achieving high availability, rapidly deriving diversified design styles so as to greatly expand application scope of images and effectively reduce human production cost.",
		"id":2530
	},
	{
		"introduce":"Image Style Classification  Open Beta",
		"name":"Image Style Classification  Open Beta",
		"description":"The Image Style Classification service is a function reading image information and realizing intelligent classification and management as per styles. By building the sample data set training machine, a style prediction model is created by a deep learning engine. According to the model, characteristic style elements can be recognized from image information and image design style is automatically distinguished.",
		"id":2531
	},
	{
		"introduce":"Intelligent Recommendation  Official Release",
		"name":"Intelligent Recommendation  Official Release",
		"description":"Based on advanced big data and artificial intelligence technology of JD, Intelligent Recommendation digs out perfect group packages and profile tags as per commodities launched by the merchant in the advertising scenario and guides the launch, to help the merchants increase their advertisement benefits.",
		"id":2532
	},
	{
		"introduce":"Marketing Cloud  Official Release",
